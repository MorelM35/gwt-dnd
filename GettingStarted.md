...
|:------------------------------------|:--------------------------------|:--------------------------------------|
| [GWT 2.6.1](http://code.google.com/p/google-web-toolkit/downloads/list) or newer | [gwt-dnd-3.3.3.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.6.0](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.3.0.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.5.1](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.2.3.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.5.0](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.2.2.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.4.0](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.1.2.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.3.0](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.1.1.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.2.0](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.1.0.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.1.1](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.0.1.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.1.0](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.0.1.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 2.0.x](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-3.0.1.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.7.0](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-2.6.5.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.6.4](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-2.6.5.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.5.3](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-2.5.6.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.5.2](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt-dnd-2.5.6.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.5.1](http://code.google.com/p/google-web-toolkit/downloads/list) (1.5 RC2) | [gwt-dnd-2.5.6.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.5.0](http://code.google.com/p/google-web-toolkit/downloads/list) (1.5 RC1) | [gwt-dnd-2.5.6.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| GWT 1.5M2 (1.5 Milestone 2)| Do not use GWT1.5M2 as it does not work with gwt-dnd. | - |
| [GWT 1.4.62](http://code.google.com/p/google-web-toolkit/downloads/list) (1.4 Update 2) | [gwt-dnd-2.0.7.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.4.61](http://code.google.com/p/google-web-toolkit/downloads/list) (1.4 Update) | [gwt-dnd-2.0.7.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.4.60](http://code.google.com/p/google-web-toolkit/downloads/list) (1.4) | [gwt-dnd-2.0.7.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 2.x |
| [GWT 1.4.59](http://code.google.com/p/google-web-toolkit/downloads/list) (1.4 RC2) | [gwt-dragdrop-1.2.6.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | [1.x API](http://code.google.com/p/gwt-dnd/wiki/GettingStartedWith1_x) |
| [GWT 1.4.10](http://code.google.com/p/google-web-toolkit/downloads/list) (1.4 RC1) | [gwt-dragdrop-1.1.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | [1.x API](http://code.google.com/p/gwt-dnd/wiki/GettingStartedWith1_x) |
| [GWT 1.3.3](http://code.google.com/p/google-web-toolkit/downloads/list) | [gwt1.3.3-dragdrop-2007-11-02.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) | 0.x API |
...
# Adding gwt-dnd to an (Eclipse) GWT Project #
  ...
  1. Download the latest [gwt-dnd-&lt;version&gt;.jar](https://code.google.com/p/gwt-dnd/wiki/Downloads) and place it in a convenient location.
...
```
  1. (Optional) if you want to play with the demo (examples), you'll need to grab those from the [Subversion trunk demo directory](http://gwt-dnd.googlecode.com/svn/trunk/DragDrop/demo/) as there is no jar file for the demos (i.e. the `com.allen_sauer.gwt.dnd.demo` package). See the [Using Source with Eclipse](http://code.google.com/p/gwt-dnd/wiki/UsingSourceWithEclipse) wiki for more details.
...
There are some [working examples](https://gwt-dnd.appspot.com/) along with the [demo source code](http://code.google.com/p/gwt-dnd/source/browse/trunk/DragDrop/demo/) for you to look at.

There's also the [library source code](http://code.google.com/p/gwt-dnd/source/browse/trunk/DragDrop/src/) if you want to see what makes it tick.